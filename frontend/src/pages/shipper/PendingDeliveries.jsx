          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-4">
              {deliveries.map((delivery) => {
                ...
                return (
                  <div key={delivery._id} className="bg-surface-container-lowest rounded-2xl shadow-apple border border-surface-variant/30 p-5">
                    <div className="flex items-start justify-between gap-4 mb-4">
                      ...
                      <span className="text-sm font-bold text-primary">Phí ship: {delivery.deliveryFee?.toLocaleString()}₫</span>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mb-4 p-4 bg-surface-container-low rounded-xl">
                      ...
                      <div className="flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-on-surface-variant">{delivery.deliveryAddress}</p>
                        </div>
                      </div>
                    </div>

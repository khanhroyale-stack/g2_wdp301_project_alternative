            ...
            <Card className="min-w-[210px] border-success/20 bg-[#f5fdf8] shadow-sm transition-shadow hover:shadow-md">
              <CardContent className="flex items-start gap-3 pt-6">
                ...
                <div>
                  ...
                  <div className="mt-1 text-[2rem] font-extrabold leading-none">{completedCount}</div>
                  <div className="mt-1 text-sm text-muted-foreground">Đơn đã giao hoặc hoàn tất</div>
                </div>
              </CardContent>
            </Card>
          </div>

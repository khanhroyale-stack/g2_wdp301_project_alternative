...
(Long)
Phụ trách toàn bộ phần tài khoản, phân quyền, xác minh email bằng OTP, điểm uy tín.
Lưu ý: KHÔNG có luồng Admin duyệt tài khoản. KHÔNG có KYC (upload CCCD/thẻ SV).
Người dùng đăng ký xong → xác thực OTP email → dùng được ngay.
...
Hiển thị họ tên, email, số điện thoại, địa chỉ, ảnh đại diện
8
Cập nhật thông tin cá nhân
Sửa họ tên, số điện thoại, địa chỉ, ảnh đại diện
9
Xem hồ sơ công khai người dùng khác
Hiển thị tên, điểm uy tín, trạng thái (dùng cho trang người bán)
10
Kiểm tra trạng thái tài khoản
ACTIVE, BANNED (không có PENDING/APPROVED vì không cần duyệt)
...
1
Tạo vai trò
Admin, User, Shipper (mặc định đăng ký là User)
2
Gán vai trò cho tài khoản
Admin đổi role user thành Shipper hoặc Admin
3
...
3. Verification — Xác minh email bằng OTP
(Không có KYC, không có upload CCCD/thẻ sinh viên, không có Admin duyệt tài khoản)
STT
Chức năng
Mô tả
1
Gửi OTP email khi đăng ký
Hệ thống gửi mã 6 số đến email
2
Xác thực OTP
User nhập OTP để kích hoạt tài khoản
3
Gửi lại OTP
User yêu cầu gửi lại nếu không nhận được (cooldown 60s)
4
OTP hết hạn
Mã OTP có thời hạn, nhập sai quá số lần thì phải gửi lại
...
Hiện ở trang hồ sơ người bán/người cho thuê
3
Trừ điểm vi phạm nhẹ (warning)
Trừ 10 điểm
4
Trừ điểm vi phạm trung bình (minor)
Trừ 20 điểm
5
Trừ điểm vi phạm nghiêm trọng (major)
Trừ 50 điểm
6
...
Chuyển accountStatus sang BANNED
8
Chặn tài khoản bị khóa
Không cho đăng bài, mua, thuê, nhận giao dịch
9
Admin xem lịch sử uy tín từng user
Xem danh sách log trừ điểm của user cụ thể
10
Admin trừ điểm thủ công
Admin chọn mức vi phạm + nhập lý do và trừ điểm
